      ...
      <View style={styles.screen}>
        <View style={styles.container}>
          ...
          <Text style={styles.con}>
           ...
           <Text style={styles.mobi}> {mobileNumber}</Text>
          </Text>
        </View>
        ...
        <View style={styles.textContainer}>
          {error && <Text style={{ color: "red",paddingHorizontal:55,fontSize:18,fontFamily:"open-sans-bold",marginBottom:40 }}>{error}</Text>}
